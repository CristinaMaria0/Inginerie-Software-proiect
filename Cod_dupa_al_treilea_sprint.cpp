...
void aplicback(){
    cout<<"  Mai jos veti avea de rezolvat 4 probleme din acest capitol"<<endl;
...
void gre_aplicatii()
{
    ...
    cout<<"    Grad dificultate:medie"<<endl;
    cout<<"  3.Se dau n numere naturale. Sa se gaseasca o subsecventa astfel incat suma elementelor din aceasta subsecventa sa fie divizibila cu n."<<endl;
    cout<<"    Grad dificultate:medie"<<endl;
